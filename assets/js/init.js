...
function tm_owl_carousel(){
	...
	var carousel2			= jQuery('.tm_testimonials .owl-carousel');
...
function tm_down(){
	...
	var topbar		= jQuery('.tm_topbar').outerHeight();
	jQuery('.tm_hero .tm_button a').on('click',function(){
		if($('.tm_topbar').length){
			if($.attr(this, 'href') !== '#'){
			$('html, body').animate({
	...
	jQuery('.tm_intro .tm_button a').on('click',function(){
...
function tm_modalbox_news(){
	...
	var list 		= jQuery('.tm_news ul li');
	var closePopup	= modalBox.find('.close');
	
	list.each(function(){
		var element 	= jQuery(this);
		var details 	= element.find('.list_inner').html();
		var buttons 	= element.find('.tm_full_link, .news_details .title a');
...
function tm_modalbox(){
	...
	var modalBox	= jQuery('.tm_modalbox');
	var list 		= jQuery('.tm_services ul li');
	var closePopup	= modalBox.find('.close');
	
	list.each(function(){
		var element 	= jQuery(this);
		var details 	= element.find('.list_inner').html();
		var buttons 	= element.find('.tm_full_link');
		var mainImage	= element.find('.main');
		var imgData		= mainImage.data('img-url');
		buttons.on('click',function(){
			jQuery('body').addClass('modal');
